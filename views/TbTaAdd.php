...
loadjs.ready(["wrapper", "head"], function () {
    var $ = jQuery;
    // Form object
    ftb_taadd = new ew.Form("ftb_taadd", "add");
    currentPageID = ew.PAGE_ID = "add";
    currentForm = ftb_taadd;
    ...
    // Form_CustomValidate
    ftb_taadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    ftb_taadd.validateRequired = ew.CLIENT_VALIDATE;

    // Dynamic selection lists
    loadjs.done("ftb_taadd");
});
</script>
<script>
...
$Page->showMessage();
?>
<form name="ftb_taadd" id="ftb_taadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
