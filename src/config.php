...
$CONFIG = [
    ...
    "RANDOM_KEY" => 'SpK0LCC4esvCJezN', // Random key for encryption
    "ENCRYPTION_KEY" => '', // Encryption key for data protection
    "PROJECT_STYLESHEET_FILENAME" => "css/studentt.css", // Project stylesheet file name
    ...
    "MAX_FILE_SIZE" => 500000000, // Max file size
