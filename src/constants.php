...
// Product version
define(PROJECT_NAMESPACE . "PRODUCT_VERSION", "18.2.0");

// Project
define(PROJECT_NAMESPACE . "PROJECT_NAME", "STUDENTT"); // Project name
define(PROJECT_NAMESPACE . "PROJECT_ID", "{4B91A56F-C658-44AC-8C5B-B059FCE18C2D}"); // Project ID
