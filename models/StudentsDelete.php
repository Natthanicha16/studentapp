 ...
 * Page class
 */
class StudentsDelete extends Students
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "StudentsDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("studentslist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("studentslist"); // Return to list
                return;
            }
        }
