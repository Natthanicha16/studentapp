...
class AddressView extends Address
{
    ...
    // Page object name
    public $PageObjName = "AddressView";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("address_id") ?? Route("address_id")) !== null) {
            $this->RecKey["address_id"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
                    ...
                    if (!$this->IsModal) { // Normal view page
                        ...
                        if ($this->TotalRecords <= 0) { // No record found
                            ...
                            while (!$this->Recordset->EOF) {
                                if (SameString($this->address_id->CurrentValue, $this->Recordset->fields['address_id'])) {
                        ...
                        if (!$matchRecord) {
                            ...
                            $returnUrl = "addresslist"; // No matching record, return to list
                        } else {
            ...
            $returnUrl = "addresslist"; // Not page request, return to list
        }
        if ($returnUrl != "") {
