 ...
 * Page class
 */
class StudentsEdit extends Students
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "StudentsEdit";
    ...
    protected function validateForm()
    {
        ...
        if (in_array("tbstudy", $detailTblVar) && $detailPage->DetailEdit) {
        ...
        if (in_array("tb_ta", $detailTblVar) && $detailPage->DetailEdit) {
            $validateForm = $validateForm && $detailPage->validateGridForm();
        }
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // student_images
            if ($this->student_images->Visible && !$this->student_images->ReadOnly && !$this->student_images->Upload->KeepFile) {
                $this->student_images->Upload->DbValue = $rsold['student_images']; // Get original value
            ...
            // student_code
            $this->student_code->setDbValueDef($rsnew, $this->student_code->CurrentValue, "", $this->student_code->ReadOnly);
            ...
            // hobby
            $this->hobby->setDbValueDef($rsnew, $this->hobby->CurrentValue, null, $this->hobby->ReadOnly);
            if ($this->student_images->Visible && !$this->student_images->Upload->KeepFile) {
                ...
                if (!EmptyValue($this->student_images->Upload->FileName)) {
                    ...
                    $this->student_images->setDbValueDef($rsnew, $this->student_images->Upload->FileName, null, $this->student_images->ReadOnly);
                }
            }
